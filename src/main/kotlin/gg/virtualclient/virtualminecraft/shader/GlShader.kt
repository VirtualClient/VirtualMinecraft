...
//$$ ) : VirtualShader {
//$$     private var program: Int = VirtualRenderSystem.glCreateProgram()
//$$     private var vertShader: Int = VirtualRenderSystem.glCreateShader(GL20.GL_VERTEX_SHADER)
//$$     private var fragShader: Int = VirtualRenderSystem.glCreateShader(GL20.GL_FRAGMENT_SHADER)
...
//$$         blendState.activate()
//$$
//$$         VirtualRenderSystem.glUseProgram(program)
//$$         bound = true
//$$     }
//$$
...
//$$
//$$         VirtualRenderSystem.glUseProgram(0)
//$$         bound = false
//$$     }
//$$
...
//$$             VirtualRenderSystem.glCompileShader(shader)
//$$
//$$             if (VirtualRenderSystem.glGetShaderi(shader, GL20.GL_COMPILE_STATUS) != 1) {
//$$                 println(VirtualRenderSystem.glGetShaderInfoLog(shader, 32768))
//$$                 return
//$$             }
//$$
//$$             VirtualRenderSystem.glAttachShader(program, shader)
//$$         }
//$$
//$$         VirtualRenderSystem.glLinkProgram(program)
//$$
//$$         if (CORE) {
...
//$$         }
//$$
//$$         if (VirtualRenderSystem.glGetProgrami(program, GL20.GL_LINK_STATUS) != 1) {
//$$             println(VirtualRenderSystem.glGetProgramInfoLog(program, 32768))
//$$             return
//$$         }
//$$
//$$         if (CORE) glValidateProgram(program) else glValidateProgramARB(program)
//$$
//$$         if (VirtualRenderSystem.glGetProgrami(program, GL20.GL_VALIDATE_STATUS) != 1) {
//$$             println(VirtualRenderSystem.glGetProgramInfoLog(program, 32768))
//$$             return
//$$         }
//$$
...
//$$
//$$     companion object {
//$$         val CORE = VirtualRenderSystem.isOpenGl21Supported()
//$$     }
//$$ }
//$$
